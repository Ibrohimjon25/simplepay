...
class UserSearch extends User
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'verification_token', 'surname', 'birthdate', 'date_membership', 'profession', 'description', 'phone_number', 'img'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['ilike', 'username', $this->username])
            ...
            ->andFilterWhere(['ilike', 'date_membership', $this->date_membership])
            ->andFilterWhere(['ilike', 'profession', $this->profession])
